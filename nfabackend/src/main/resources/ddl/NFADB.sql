...
INSERT INTO nfa VALUES (1,1,'Type:1','Bezeichnung:1','Verbindlichkeit:1','12.22','Formulierung:1',null,'erklaerung:1','referenz:1','referenzierte_projekt:1','kritikalitaet', 'document1');
INSERT INTO nfa VALUES (2,1,'Type:1','Qualität der Arbeit','Verbindlichkeit:1','12.22','Formulierung:1',null,'Das System muss dem bzw. der Anwender_in dabei unterstützen, ihre bzw. seine Aufgaben mit hoher Qualität, Genauigkeit und Effizienz zu erledigen.','JUAC','CbCR','kritikalitaet', 'document1');
INSERT INTO nfa VALUES (3,1,'Type:1','Fehleranteil','Verbindlichkeit:1','12.22','Formulierung:1',null,'Die Anzahl der Fehler darf nicht höher sein als 0,1% aller durchgeführten Operationen eines bzw. einer Anwender_in im System.','','','kritikalitaet', 'document1');
INSERT INTO nfa VALUES (4,1,'Type:1','Entstehende Fehler','Verbindlichkeit:1','12.22','Formulierung:1',null,'Bei der Bearbeitung von Aufgaben mit dem System sollen möglichst keine Fehler entstehen.','referenz:1','referenzierte_projekt:1','kritikalitaet', 'document1');
INSERT INTO nfa VALUES (5,1,'Type:1','Fehlerfreie Bedienung','Verbindlichkeit:1','12.22','Formulierung:1',null,'Der bzw. die Anwender_in muss das System möglichst fehlerfrei bedienen können.','referenz:1','referenzierte_projekt:1','kritikalitaet', 'document1');

INSERT INTO nfa VALUES (6,1,'Type:1','Umsatz je Kunde','Verbindlichkeit:1','12.22','Formulierung:1',null,'Das System erwirtschaftet einen messbaren Umsatz je Kunde.','JUAC','referenzierte_projekt:1','kritikalitaet', 'document1');
INSERT INTO nfa VALUES (7,1,'Type:1','Kranke Nutzer','Verbindlichkeit:1','12.22','Formulierung:1',null,'Das System muss eine Erhöhung Anzahl der krankheitsbedingten Ausfälle der Anwender_innen, die unmittelbar durch die Systemnutzung verursacht werden, verhindern.','referenz','referenzierte_projekt:1','kritikalitaet', 'document1');
INSERT INTO nfa VALUES (8,1,'Type:1','Störung des Wohlbefindens','Verbindlichkeit:1','12.22','Formulierung:1',null,'Das System muss die Störung des Wohlbefindens eines bzw. einer Anwender_in verhindern.','JUAC','referenzierte_projekt:1','kritikalitaet', 'document1');
INSERT INTO nfa VALUES (9,2,'Type:1','Vermeidung von epileptischen Anfällen 1','Verbindlichkeit:1','12.22','Formulierung:1',null,'Inhalte müssen so zu gestaltet sein, dass keine epileptischen Anfälle ausgelöst werden.','DIN EN ISO 9241-171: 2008; BITV','CbCR','kritikalitaet', 'document1');
INSERT INTO nfa VALUES (10,3,'Type:1','Anpassung der taktilen Ausgabe','Verbindlichkeit:1','12.22','Formulierung:1',null,'Die Software sollte aus dem täglichen Leben vertraute Muster bereitstellen, um Meldungen taktiler Art zu beschreiben.','DIN EN ISO 9241-171','','kritikalitaet', 'document1');
